    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserConversationStatuses", x => new { x.UserId, x.ConversationId });
                    table.ForeignKey(
                        name: "FK_UserConversationStatuses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SignatureId",
                table: "AspNetUsers",
                column: "SignatureId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserConversationStatuses_ConversationId",
                table: "UserConversationStatuses",
                column: "ConversationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserConversationStatuses_Status",
                table: "UserConversationStatuses",
                column: "Status");
